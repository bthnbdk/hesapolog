...
The `netlify.toml` file in the root of the project contains all the necessary build configurations and redirect rules to ensure the statically exported site works correctly.
