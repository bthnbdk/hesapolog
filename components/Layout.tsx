...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // API Route Check: If the path is for the API, render children directly.
      ...
      >
        <div className="container mx-auto px-4 md:px-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1 bg-white/50 backdrop-blur-md px-2 py-1.5 rounded-full border border-brand-dark/5 shadow-sm">
           ...
           {/* Universal Install/Bookmark Button */}
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="grid md:grid-cols-12 gap-12 mb-16">
            ...
            <div className="md:col-span-5 space-y-6">
              ...
              {/* Newsletter Mock */}
              <div className="pt-4">
                 <h4 className="text-xs font-bold uppercase tracking-widest text-brand-beige mb-3">Güncellemelerden Haberdar Ol</h4>
                 <div className="flex gap-2 max-w-sm">
                    <input type="email" placeholder="E-posta adresiniz" className="flex-1 bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-sm text-brand-light placeholder:text-brand-light/30 focus:outline-none focus:border-brand-beige/50 transition-colors" />
                    <button className="px-5 py-3 bg-brand-beige text-brand-dark font-bold text-sm rounded-lg hover:bg-white transition-colors">Kayıt Ol</button>
                 </div>
              </div>
            </div>
            ...
            <div className="md:col-span-2 md:col-start-7">
               ...
               <ul className="space-y-3 text-sm text-brand-light/60">
                 <li><Link to="/kredi-hesaplama" className="hover:text-brand-beige transition-colors">Kredi Hesaplama</Link></li>
                 <li><Link to="/maas-hesaplama" className="hover:text-brand-beige transition-colors">Maaş Hesaplama</Link></li>
                 <li><Link to="/bmi-vucut-kitle-indeksi-hesaplama" className="hover:text-brand-beige transition-colors">BMI Hesaplama</Link></li>
                 <li><Link to="/yuzde-hesaplama" className="hover:text-brand-beige transition-colors">Yüzde Hesaplama</Link></li>
                 <li><Link to="/mtv-hesaplama" className="hover:text-brand-beige transition-colors">MTV Hesaplama</Link></li>
               </ul>
            </div>
            ...
            <div className="md:col-span-2">
               ...
               <ul className="space-y-3 text-sm text-brand-light/60">
                 <li><Link to="/hakkimizda" className="hover:text-brand-beige transition-colors">Hakkımızda</Link></li>
                 <li><Link to="/gizlilik-politikasi" className="hover:text-brand-beige transition-colors">Gizlilik Politikası</Link></li>
                 <li><Link to="/kullanim-sartlari" className="hover:text-brand-beige transition-colors">Kullanım Şartları</Link></li>
                 <li><Link to="/iletisim" className="hover:text-brand-beige transition-colors">İletişim</Link></li>
                 <li><Link to="/sitemap" className="hover:text-brand-beige transition-colors">Site Haritası</Link></li>
               </ul>
            </div>
