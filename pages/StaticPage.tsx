...
const content = {
  about: {
    title: "Hakkımızda",
    description: "Hesapolog'un misyonu, vizyonu ve değerleri hakkında daha fazla bilgi edinin. Neden Türkiye'nin en güvenilir hesaplama platformu olduğumuzu keşfedin.",
    body: `
      <h2>Misyonumuz</h2>
  ...
  privacy: {
    ...
    description: "Hesapolog'u kullanırken gizliliğinizin nasıl korunduğunu öğrenin. Veri toplama, çerez kullanımı ve üçüncü taraf hizmetleri hakkındaki politikamızı inceleyin.",
    body: `
  ...
  terms: {
    ...
    description: "Hesapolog platformunu kullanmadan önce hizmet şartlarımızı okuyun. Hesaplamaların doğruluğu, sorumluluk reddi ve fikri mülkiyet hakları hakkında bilgi edinin.",
    body: `
  ...
  contact: {
    title: "İletişim",
    description: "Öneri, geri bildirim veya hata bildirimi için bizimle iletişime geçin. Hesapolog'u daha iyi bir platform haline getirmemize yardımcı olun.",
    body: `
...
export const StaticPage: React.FC<Props> = ({ type }) => {
  const { title, body, description } = content[type];
  ...
  return (
    <>
      <SEO pageType={type} title={title} description={description} noIndex />
